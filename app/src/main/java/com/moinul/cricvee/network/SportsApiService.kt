...
interface SportsApiService {
    ...
    suspend fun fetchAllFixtures(
        @Query("page") currentPage: Int, @Query("api_token") api_token: String = Constants.API_KEY
    ): AllFixtures
    ...
    suspend fun fetchCurrentSquad(
        @Path("teamId") teamId: Int, @Query("api_token") api_token: String = Constants.API_KEY
    ): CurrentSquad
